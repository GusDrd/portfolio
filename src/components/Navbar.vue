<template>
  <div class="navbar" :class="{'dark-mode': getDarkMode, 'tablet-view': isTablet}">
    <div class="tablet-bar" v-if="isTablet">
      <h1>AD.</h1>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 24 18" fill="#333">
        <path d="M0 1.58824C0 0.711077 0.711077 0 1.58824 0H22.4118C23.2889 0 24 0.711077 24 1.58824V1.58824C24 2.46539 23.2889 3.17647 22.4118 3.17647H1.58824C0.711077 3.17647 0 2.46539 0 1.58824V1.58824Z"/>
<path d="M0 9C0 8.12284 0.711077 7.41177 1.58824 7.41177H22.4118C23.2889 7.41177 24 8.12284 24 9V9C24 9.87716 23.2889 10.5882 22.4118 10.5882H1.58824C0.711077 10.5882 0 9.87716 0 9V9Z"/>
<path d="M0 16.4118C0 15.5346 0.711077 14.8235 1.58823 14.8235H22.4118C23.2889 14.8235 24 15.5346 24 16.4118V16.4118C24 17.2889 23.2889 18 22.4118 18H1.58823C0.711076 18 0 17.2889 0 16.4118V16.4118Z"/>
      </svg>
    </div>
